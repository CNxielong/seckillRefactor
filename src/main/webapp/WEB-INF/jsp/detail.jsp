...
<%--&lt;%&ndash;<script src="http://cdn.bootcss.com/jquery-cookie/1.4.1/jquery.cookie.min.js"></script>&ndash;%&gt;--%>
<%--&lt;%&ndash;jQuery countDown倒计时插件&ndash;%&gt;--%>
<%--<script src="https://cdn.bootcss.com/jquery.countdown/2.2.0/jquery.countdown.min.js"></script>--%>
<%--&lt;%&ndash;<script src="http://cdn.bootcss.com/jquery.countdown/2.1.0/jquery.countdown.min.js"></script>&ndash;%&gt;--%>
<%--&lt;%&ndash;开始编写交互逻辑&ndash;%&gt;--%>
    ...
    <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
            <h2 class="text-danger">
                ...
                <%-- 展示倒计时 --%>
                <span class="glyphicon" id="secjukk-box"></span>
            </h2>
        </div>
    </div>
